...
class FC_Camera extends FC_GameObject {
    ...
    get Position() { return this._Object ? this._Object.position : null; }
    get Position_LookAt() { return this._Position_LookAt; }
    get Flag_Target() { return this._Flag_Target; }
    get Target() { return this._Target; }

    set Position(_vector3) {
        if (this._Object) this._Object.position.copy(_vector3);
    }
    set LookAt(_vector3) {
        this._Position_LookAt = _vector3;
        if (this._Object) this._Object.lookAt(this._Position_LookAt);
    }
    set Target(_target) {
        if (_target == null) {
    ...
    Update() {
        if (this._Flag_Target && this._Target) {
    ...
    Resize_Screen() {
        if (this._Object && this._Renderer) {
            this._Object.aspect = this._Renderer.domElement.width / this._Renderer.domElement.height;
            this._Object.updateProjectionMatrix();
            this._Renderer.setSize(this._Renderer.domElement.width, this._Renderer.domElement.height);
        } else {
            console.error('Camera object or renderer is not initialized');
        }
    }
}
